...
file_ObjJacHess = open('ObjJacHess.obj', 'w')
...
if len_zeros > 0:
    tuples_rowcol = zip(row,col)
    tuples_rowcol = set(tuples_rowcol)
    row,col = zip(*tuples_rowcol)
    tuples_rowcol = zip(row,col)
...
tuples_rowcol_final = zip(row_final,col_final) 
tuples_rowcol_final = set(tuples_rowcol_final)
row_final,col_final = zip(*tuples_rowcol_final)
tuples_rowcol_final = zip(row_final,col_final)
